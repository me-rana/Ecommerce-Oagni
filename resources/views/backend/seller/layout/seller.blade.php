...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="{{route('admin.dashboard')}}" class="logo d-flex align-items-center">
        ...
        <h1 class="navmenu">Seller Panel</h1>
      </a>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            <img src="../../../backend-assets/img/user.png" alt="Profile" class="rounded-circle">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            ...
            <li>
              ...
              <li class="dropdown-item d-flex align-items-center" ><i class="bi bi-box-arrow-right"></i>  <span><form method="POST" action="{{ route('logout') }}" x-data>@csrf <input class="btn nav-link" type="submit" value='Logout'></form></span></li>
            </li>
  ...
  @include('backend.seller.layout.navigation-menu')
            <!-- Page Content -->
